...
class PasteFile(db.Model):
    ...
    def get_by_symlink(cls, symlink, code=404):
        id = short_url.encode_url(symlink)
    ...
    @classmethod
    def creat_by_upload_file(cls, uploaded_file):
        rst = cls(uploaded_file.filname, uploaded_file.mimetype, 0)
    ...
    @classmethod
    def creat_by_old_paste(cls, filehash):
    ...
    def rsize(cls, old_paste, width, height):
        ...
        img = cropresize2.crop_resize(im, (int(width), int(height)))
